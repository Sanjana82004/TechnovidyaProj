    ...
    StudentFeeForm(){
      ...
      setLayout(null);
       ...
       JLabel labelname = new JLabel();
        ...
        String course[]= {"BTech", "BCA","Bsc","Msc", "MBA","MCA","MCom","MA"};
       ...
       add(cbbranch);
        ...
        update.setFont(new Font("Tahoman",Font.BOLD, 15));
        add(update);
       ...
       pay.addActionListener(this);
        pay.setFont(new Font("Tahoman",Font.BOLD, 15));
        add(pay);
       ...
       back.addActionListener(this);
        back.setFont(new Font("Tahoman",Font.BOLD, 15));
        add(back);
